                    ...
                    <form action="/app/recipe/edit" method="post">
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7">
                                    <input class="w-100 p-1" name="recipe_name" value="${recipe.name}">
                                </td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Opis przepisu</th>
                                <td class="col-7">
                                    <input class="w-100 p-1" name="recipe_description" value="${recipe.description}">
                                </td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                                <td class="col-3">
                                    <input class="p-1" type="number" name="preparation_time" value="${recipe.preparation_time}">
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="row d-flex">
                            <div class="col-5 p-4">
                                <input class="w-100 p-1"  type="text" name="preparation" value="${recipe.preparation}">
                                <input hidden type="text" name="recipeID" value="${recipe.id}">
                            </div>
                            <div class="col-2"></div>

                            <div class="col-5 p-4">
                                <input class="w-100 p-1"  type="text" name="ingredients" value="${recipe.ingredients}">
                            </div>
                        </div>
                    </form>
                </div>
